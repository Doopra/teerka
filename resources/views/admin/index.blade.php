                    ...
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          ...
                          <p class="mb-4">
                            You will get a bonus of <span class="fw-medium">2%</span> for all successful bookings 
                          </p>

                          <a href="javascript:;" class="btn btn-sm btn-outline-primary">View payment</a>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-medium d-block mb-1">Total Product Listed</span>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="d-block mb-1">Total Bookings</span>
                          <h3 class="card-title text-nowrap mb-2">{{ $bookings }}</h3>
                    ...
                    <div class="col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <span class="fw-medium d-block mb-1">Total Surprises</span>
