      ...
      <ul class="navbar-nav w-100">
        <li class="nav-item w-100">
          <form class="nav-link mt-2 mt-md-0 d-none d-lg-flex search" action="{{url('search')}}" method="get">
            ...
            @csrf
            <input type="text" class="form-control" style="color: white; border: 2px solid white " placeholder="Search products" name="search">
            <input type="submit" value="Search" class="btn btn-outline-primary" style="margin-left:10px; border: 2px solid white;border-radius:10px">
          </form>
        </li>
      </ul>
